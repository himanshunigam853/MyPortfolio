...
const Contact = () => {
  ...
  return (
    <>
        <div id='Contact' className="grid-rows-1 border-2 flex-column contact-color">
          <h1 className="pt-8 text-4xl font-semibold text-center">
            Contact Form
          </h1>
          <div className="contact-color border w-2/4 m-auto ">
            <form className="p-5 m-auto " 
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 p-5">
                    ...
                    <div className="sm:col-span-3">
                      <input type="hidden" name="access_key" value='f8d57b38-7ddd-475b-a68d-3bd7ece94007'></input>
                      <label
                        htmlFor="first-name"
